                        ...
                        <ul class="nav navbar-nav">
                            <li class="nav-item d-none d-lg-block"><a class="nav-link bookmark-star"><i class="ficon bx bx-star warning"></i></a>
                                <div class="bookmark-input search-input">
                                    ...
                                    <input class="form-control input" type="text" placeholder="Explore Ciao..." tabindex="0" data-search="template-search">
                        ...
                        <!--<li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none">
                                    ...
                                    <span class="user-status text-muted"><?= htmlspecialchars($autoscuola->email, ENT_QUOTES, 'UTF-8') ?></span>
                                </div>
                                <span>
                                    <div class="icon-wrapper round" style="padding: 5px; border: 1px solid #fff" onclick="location.href='/logout'">
                                        <span class="livicon-evo" data-options="name: morph-powerswitch.svg; style: lines; size: 30px; strokeColor: #ffffff; eventOn: grandparent; drawOnViewport: false "></span>
                                    </div>
                            ...
                            <i class="bx bx-user mr-50"></i> Edit Profile</a><a class="dropdown-item" href="app-email.html"><i class="bx bx-envelope mr-50"></i> My Inbox</a><a class="dropdown-item" href="app-todo.html"><i class="bx bx-check-square mr-50"></i> Task</a><a class="dropdown-item" href="app-chat.html"><i class="bx bx-message mr-50"></i> Chats</a>
